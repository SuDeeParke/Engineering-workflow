...
if (!fs.existsSync(metaSkill)) {
  process.stdout.write(
    JSON.stringify({
      priority: "INFO",
      message:
        "engineering-lifecycle: using-agent-skills not found. Skills are still available under ./skills/.",
    }),
  );
  process.exit(0);
}
...
const message =
  "engineering-lifecycle loaded. Start with the skill discovery flow before implementing.\n\n" +
  content;
